                        ...
                        <div class="breadcrumbs-inner">
                            <div class="container">
                                <div class="breadcrumbs-text">
                                    <h1 class="breadcrumbs-title">Teşvik ve Hibeler</h1>
                    ...
                    <div class="container-fluid" style="padding-left:120px; padding-right:120px;">
                        <div class="row">
                            ...
                            use App\Models\Kurum;
                                    ...
                                    @foreach($tesvik as $haber)
                                    <div class="single-blog col-md-4">
                                        <div class="inner-blog">
                                            <div class="blog-img">
                                                @php
                                                    $kurum = Kurum::where('id',$haber->kurum)->first();
                                                @endphp
                                                <img src=" {{ asset('kurum/' . $kurum->resim) }}" alt="Blog Image">
                                            </div>
                                            <div class="blog-content">
                                                <div class="top-part">
                                                    ...
                                                    <h3 class="blog-title">
                                                        <a href="{{ route('tesvikdetay', ['id' => $haber->id]) }}"> {{$haber->baslik}}</a>
                                                    </h3>
                                                    <p class="blog-desc">
                                                    {{$haber->metin}}
