...
<div class="box-content card white">
				...
				<div class="box-content card white">
					...
					<div class="card-content">
						<form action="{{Route('panel-sayfa-ekle-post')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
								<label for="exampleInputEmail1">Sayfa Adı</label>
								<input name="sayfa_adi"  type="text" class="form-control" id="exampleInputEmail1" >
							</div>
							<div class="form-group">
