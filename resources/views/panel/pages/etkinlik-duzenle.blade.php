...
<div class="box-content card white">
				...
				<div class="box-content card white">
					<h4 class="box-title">ETKİNLİK DÜZENLE</h4>
					<!-- /.box-title -->
					<div class="card-content">
						<form action="{{Route('etkinlikguncellepost',$duyuru->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
								...
								<input name="tarih" value="{{$duyuru->tarih}}" type="date" class="form-control" id="exampleInputEmail1" >
							</div>
                    ...
                    <img style="width:450px; height: 250px; margin-top: 120px;" src="{{ asset('etkinlik/' . $duyuru->resim) }}"alt="">
					<!-- /.card-content -->
				</div>
            </div>
            <div class="col-lg-6 col-xs-12">
