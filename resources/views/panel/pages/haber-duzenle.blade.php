...
<div class="box-content card white">
				...
				<div class="box-content card white">
					...
					<div class="card-content">
						<form action="{{Route('haber-duzenlePost',$haber->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
							...
							<div class="form-group">
								...
								<input name="baslik" value="{{$haber->baslik}}" type="text" class="form-control" id="exampleInputEmail1" >
							</div>
                    ...
                    <img style="width:450px; height: 250px; margin-top: 120px;" src="{{ asset('haber/' . $haber->resim) }}"alt="">
					<!-- /.card-content -->
				</div>
            </div>
            <div class="col-lg-6 col-xs-12">
			...
			<div class="form-group">
								...
								<textarea name="metin" class="form-control" id="editorMetin" rows="15">{{$haber->metin}}</textarea>
